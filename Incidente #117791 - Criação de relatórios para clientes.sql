...
DECLARE @CLIENTE VARCHAR(MAX) = 'NATURA COSME'
...
SELECT  
	...
	,CASE
		WHEN GEP.GRUPO = 308986 THEN ROUND(ISNULL(ISNULL(ISNULL(DOC.DOCCLIPESOCONSIDERADO,DOC.DOCCLIPESOTOTAL),DOC.DOCCLIATUALPESOCUBADOTOTAL),0),2)
	ELSE 0 
...
WHERE 0=0
AND A.PREVISAOSAIDA >= '2020-01-01'
AND A.PREVISAOSAIDA < '2020-02-20'
