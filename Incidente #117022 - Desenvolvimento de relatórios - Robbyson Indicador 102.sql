...
FROM (
	...
	WHERE CF.DATAINCLUSAO >= DATEADD(DD, ((CASE WHEN CF.FILIAL IN (select FILIAL from GLGL_PARAMETROVALORES WHERE PARAMETRO LIKE '%VALIDADE%' AND FILIAL IS NOT NULL) THEN 15 ELSE 10 END)*(-1)), @BeginDate)
