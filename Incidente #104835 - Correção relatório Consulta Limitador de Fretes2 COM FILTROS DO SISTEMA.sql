SELECT DISTINCT --SUBSELECT PARA COMAR TUDO
 ...
 ISNULL([LINHA], ''),
 [FRETEMINIMO],
 SUM(ISNULL([TOTALFRETET2], TOTALFRETED)) , (SUM(ISNULL([TOTALFRETET2], TOTALFRETED))-SUM(ISNULL([FRETEMINIMO], 0))) ,
  ISNULL((SUM(ISNULL([TOTALFRETET2], TOTALFRETED))/SUM(NULLIF([FRETEMINIMO], 0))),0),
                                                                                                                       ISNULL([VEICULOPUXADOR], ''),
                                                                                                                       ISNULL([REBOQUE1], ''),
                                                                                                                       ISNULL([REBOQUE2], ''),
                                                                                                                       ISNULL([TIPOCLASSIFICACAOROTA], ''),
                                                                                                                       [KMCONSIDERADO],
                                                                                                                       ROUND(CASE
                                                                                                                             ...
                                                                                                                             END, 2),
                                                                                                                       SUM(ISNULL([RECEITACOLETA], 0)),
                                                                                                                       ISNULL([RECEITAENTREGA] ,0),
                                                                                                                            ROUND(SUM(ISNULL([PESOREAL], 0)), 2),
                                                                                                                            ROUND(SUM(ISNULL([PESOCUBADO], 0)), 2),
                                                                                                                            IIF(ISNULL(PESOCONSIDERADOT4, 0) + ROUND(SUM(ISNULL([PESOCOLETAREALIZADO], 0)), 2) = 0, SUM(ISNULL([PESOREAL], 0)), ISNULL(PESOCONSIDERADOT4, 0) + ROUND(SUM(ISNULL([PESOCOLETAREALIZADO], 0)), 2)), --ROUND(IIF(SUM([PESOCONSIDERADO]) = 0, SUM(ISNULL([PESOREAL],0)),SUM([PESOCONSIDERADO])),2) AS [Peso Considerado],
 SUM(ISNULL([QUANTIDADECOLETA], 0)),
 ISNULL([QUANTIDADEENTREGA], 0),
 ROUND(SUM([PESOCONSIDERADOENTREGA]), 2),
 SUM(ISNULL([QUANTIDADECOLETAREALIZADA], 0)),
 ISNULL([QUANTIDADEENTREGAREALIZADA], 0),
 ROUND(SUM(ISNULL([PESOCOLETAREALIZADO], 0)), 2),
 ROUND(SUM(ISNULL([PESOENTREGAREALIZADO], 0)), 2),
 [CAPACIDADE], --Ocupação % (formula:  Peso coleta realizada + peso entrega realizada)/capacidade) e
 ROUND(((ROUND(SUM(ISNULL([PESOCOLETAREALIZADO], 0)), 2) + ROUND(SUM(ISNULL([PESOENTREGAREALIZADO], 0)), 2))/NULLIF([CAPACIDADE], 0)),2),
 [VALORCONTRATOFRETE],
 ROUND(((NULLIF(ISNULL(VALORCONTRATOFRETE, 0), 0)/NULLIF(SUM(ISNULL(PESOCOLETAREALIZADO, 0)) + SUM(ISNULL([PESOENTREGAREALIZADO], 0)), 0))*SUM(ISNULL(PESOCOLETAREALIZADO, 0))),2),
 ROUND(((NULLIF(ISNULL(VALORCONTRATOFRETE, 0), 0)/NULLIF(SUM(ISNULL(PESOCOLETAREALIZADO, 0)) + SUM(ISNULL([PESOENTREGAREALIZADO], 0)), 0))*SUM(ISNULL([PESOENTREGAREALIZADO], 0))),2) , --"Custo Total por Receita %" (formula: valor contrato frete/Total frete) tabela abaixo com valores calculados
 ROUND((ISNULL(VALORCONTRATOFRETE, 0)/SUM(ISNULL(NULLIF([TOTALFRETET2], 0), NULLIF(TOTALFRETED, 0)))),2) , --SUM(ISNULL([TOTALFRETET2],TOTALFRETED))),2) AS [Custo Total por Receita %],
 --SUM(ISNULL([TOTALFRETET2],TOTALFRETED))),2) AS [Custo Total por Receita %],
 (SUM(ISNULL(VOLUME, 0))+ ISNULL([VOLUMEENTREGA], 0)) , SUM(ISNULL([VOLUMECOLETA], 0)),
                                                        ISNULL([VOLUMEENTREGA], 0),
                                                        ISNULL(SUM([VOLUMECARREGADO]), 0),
                                                        [BLOQUEADA],
                                                        SUM(ISNULL(VALORMERCADORIA, 0)),
                                                        VALORBLOQUEIO,
                                                        [MOTIVO],
                                                        [OBSERVACAO],
                                                        [USUARIO],
                                                        ISNULL([SUBTIPOVIAGEM], ''),
                                                        ISNULL([TIPOVEICULO], ''),
                                                        [ITINERANTE],
                                                        [VALORKM],
                                                        GENERALIDADES,
                                                        ...
                                                        FRETEVEICULO,
                                                        DESCONTOS,
                                                        ISNULL(OBSERVACAOCONTRATOFRETE, '')
FROM
