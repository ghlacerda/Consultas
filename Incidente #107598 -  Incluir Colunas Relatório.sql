	SELECT top(10) V.HANDLE,V.INICIOEFETIVO,V.PREVISAOCHEGADA,V.CHEGADAEFETIVA,V.NUMEROVIAGEM,TIPO.NOME TIPO                            
	...
	,PLACA.ORIGEM,PLACA.TIPOFROTAAGREGADA ,LINHA.HANDLE,BENEFICIARIO.NOME, BENEFICIARIO.CGCCPF,SUBTIPO.NOME		
	,CF.HANDLE,CF.FRETECOMBINADO, CFC.OBSERVACAO, CF.VALORTOTAL,BENEFICIARIO.INSSPISPASEP	
	, BENEFICIARIO.NASCIMENTO,V.PREVISAOCHEGADA,V.K_DISTANCIATOTALREAL,V.DISTANCIATOTAL,V.DISTANCIACONSIDERADA											
	, CF.NUMERO, CF.DATAEMISSAO													
