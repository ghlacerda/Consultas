...
SELECT DISTINCT  
	...
	,'' AS PESOREAL
	,'' AS VALORTOTALMERCADORIA
	,'' AS KMTOTAL
	,'' AS VALORPORKMLV
	,'' AS VALORTRANSFERENCIA
...
SELECT  DISTINCT 
	...
	,VALORBRUTO - (SUM(ISNULL([''],0))+SUM(ISNULL([Abastecimento],0))+SUM(ISNULL([Multas],0))+SUM(ISNULL([Rastreamento],0))+SUM(ISNULL([Trava e Congêneres],0))) AS VALORLIQUIDO
FROM (
SELECT  DISTINCT 
	...
	,'VALOR NÃO VEM DO SISTEMA' AS FRETECOMBINADO
